...
<div class="container cx_layout_margin_center ">
    <div class="row">
        <div class="col-md-12">
            <div class="cx_form_update_employee">
                <div class="cx_form_title">Update employee</div>
                <form class="cx_form_content" action="<?php echo site_url('Employee_Controller/update_employee');?>" method="post">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row cx_form_submit_footer">
                        <div class="col-md-6">
                            <button class="cx_link_btn_add" type="submit">Update</button>
                        </div>
                        <div class="col-md-6">

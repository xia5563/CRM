        ...
        <div class="col-md-6">
            <div class="cx_function_box cx_function_box_customer">
                ...
                <div class="container-fluid cx_function_box_content">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 cx_function_box_content_btn_under_img">
                                    <a href="<?php echo site_url('Customer/view_customers') ?>"
                    ...
                    <div class="row cx_search_customers_row">
                        <div class="col-md-4">
                            <select id="search_customers_select">
                        ...
                        <div class="col-md-5">
                            <input type="text" id="search_customers_input"  placeholder="Keywords?">
                        </div>
                        <div class="col-md-3">
                            <button id="search_customers_btn" class="cx_btn_link_search" >Search</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="cx_function_box cx_function_box_employee">
                ...
                <div class="container-fluid cx_function_box_content">
                    ...
                    <div class="row ">
                        <div class="col-md-4">
                            <a href="" class="cx_btn_link_search">Search</a>
                        </div>
                        <div class="col-md-4">
                            <a href="" class="cx_btn_link_update">Update</a>
                        </div>
                        <div class="col-md-4">
                            <a href="" class="cx_btn_link_delete">Delete</a>
                        </div>
                    </div>
                </div>
